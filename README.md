...
``` swift
internal let agoraAppID = "123456789"
internal let agoraClientToken = "987654321"
internal let agoraChannelId = "example-channel"
```

1. Open the BanubaAgoraFilters.xcodporj project in Xcode and run the `BanubaAgoraFilters` target.

:exclamation: If you have any problems with installing Agora frameworks with Swift Package Manager refer to this [page](https://github.com/AgoraIO/AgoraRtcEngine_iOS).
...
To build the BanubaFiltersAgoraExtension manually, clone [banuba's repo](https://github.com/Banuba/agora-plugin-filters-ios) and follow the steps bellow:
...
4. Then put the framework in the `/Frameworks` folder of the BanubaAgoraFilters.xcodeproj (or of your project). Then you can build BanubaAgoraFilters or your project.
...
Add effects to the `BanubaAgoraFilters/effects` directory, by downloading from [here](https://docs.banuba.com/face-ar-sdk-v1/overview/demo_face_filters).
